  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <div class="bulletin">
        ...
        <ul class="supports">
          <li class="support-item" v-for="(support,index) in shopInfo.suopprts" :key="index">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picsUl">
            <li class="pic-item" v-for="(pic,index) in shopInfo.pics" :key="index">
              <img width="120" height="90" :src="pic"></li>
...
<script>
  ...
  export default {
    data(){
      return {
        supportClasses:['decrease', 'discount', 'guarantee', 'invoice', 'special'],//显示图片数组
